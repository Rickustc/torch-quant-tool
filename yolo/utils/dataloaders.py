...
def build_dataset(model,img_path, args,mode='train', batch=None):
    """
    Build YOLO Dataset.
...
DEFAULT_CFG_PATH = "/home/wrq/anaconda3/envs/quant/lib/python3.9/site-packages/ultralytics/cfg/default.yaml"
...
def get_dataloader(model, dataset_path,cfg=DEFAULT_CFG,  batch_size=16, rank=0, mode='train'):
        """Construct and return dataloader."""
        override = {'task': 'detect', 'data': 'coco.yaml', 'imgsz': 640, 'single_cls': False, 'model': '/home/wrq/yolo/yolov8n.pt', 'epochs': 100, 'mode': 'train'}
        args = get_cfg(cfg, override)

        assert mode in ['train', 'val']
        with torch_distributed_zero_first(rank):  # init dataset *.cache only once if DDP

            dataset = build_dataset(model, dataset_path, args,mode, batch_size)
        shuffle = mode == 'train'
...
def img2label_paths(img_paths):
    ...
    sa, sb = f'{os.sep}train2017{os.sep}', f'{os.sep}train_txt{os.sep}'  # /images_Path/, /labels_path/ substrings
