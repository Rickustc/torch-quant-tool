...
# g = FxGraphDrawer(quantized_fx, "resnet_reference")
# g.get_main_dot_graph().write_svg("resnet_reference.svg")
# print(quantized_fx)
...
exported_model_path = 'resnet_quant_fx_reference_qdq_reference_shift_scale.onnx'
