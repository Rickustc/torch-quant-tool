...
if __name__ == "__main__":
    ...
    model = onnx.load("/home/wrq/neural-compressor/examples/onnxrt/image_recognition/resnet50_torchvision/quantization/ptq_static/resnet50fp32.onnx")
    ...
    if args.tune:
        ...
        q_model.save("/home/wrq/neural-compressor/examples/onnxrt/image_recognition/resnet50_torchvision/quantization/ptq_static/quant_original_INC.onnx")
        # model_ = onnx.load("/home/wrq/neural-compressor/examples/onnxrt/image_recognition/resnet50_torchvision/quantization/ptq_static/quant_original_INC.onnx")
