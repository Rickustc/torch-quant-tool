...
class QDQQuantizer(Quantizer):
    ...
    def _ort_pre_optimize(self,  level=1):
        ...
        sess_options.optimized_model_filepath = os.path.join(os.getcwd(), "Optimized_model.onnx")
...
# qmodel = onnx_qdq_to_qlinear("/home/wrq/neural-compressor/examples/onnxrt/image_recognition/resnet50_torchvision/quantization/ptq_static/resnet50_quant_int8_conv_acc78.onnx")
# print(qmodel.opset_import)
