...
def main():
    ...
    save_path = "./onnx_model/ptq_int8_resnet.onnx"
    onnx_quant_model = torch_to_int8_onnx(quant_model,example_input=image_tensor,save_path=save_path)
    
    cos_similarity = cos_similarity_bettween_model(quant_model,save_path,image_tensor)
